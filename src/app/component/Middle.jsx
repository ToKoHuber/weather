export default function Middle() {
  return (
    <div className=" border-2 border-muted-foreground/20 rounded-full h-[730px] w-[730px] flex justify-center items-center absolute">
      <div className=" border-2 border-muted-foreground/20 rounded-full h-[480px] w-[480px] flex justify-center items-center">
        <div className=" border-2 border-muted-foreground/20 rounded-full h-[300px] w-[300px] justify-center items-center flex">
          <div className="border-2 border-muted-foreground/20 roundedfull flex gap-3 items-center justify-center bg-white rounded-full h-[100px] w-[100px] ">
            <svg
              width="43"
              height="86"
              viewBox="0 0 43 86"
